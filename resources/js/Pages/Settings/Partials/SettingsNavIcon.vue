...
const props = defineProps({
  ...
  className: { type: String, default: 'h-4 w-4' },
})
...
const ICONS = {
  ...
  chat: [
    'M8 10h8M8 14h5m-7 6l2.5-2.5A9 9 0 113 12v8z',
  ],
  bolt: [
  ...
  map: [
    'M9 20l-5.447-2.724A1 1 0 013 16.382V5.618a1 1 0 01.553-.894L9 2m0 18l6-3m-6 3V2m6 15l5.447 2.724A1 1 0 0021 18.382V7.618a1 1 0 00-.553-.894L15 4m0 13V4m0 0L9 2',
  ],
  'user-group': [
  ...
  refresh: [
    'M4 4v6h6M20 20v-6h-6',
    'M20 14a8 8 0 00-14.828-3M4 10a8 8 0 0014.828 3',
  ],
  cog: [
...
const paths = computed(() => ICONS[props.name] || ICONS.cog)
</script>
